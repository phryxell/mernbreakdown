...
export default class EditBreakdown extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    axios.get('https://mernbreakdown.herokuapp.com/breakdowns/'+this.props.match.params.id) //Get id directly from the URL
      .then(response => { 
        this.setState({
          username: response.data.username,
          description: response.data.description,
          breakdowntime: response.data.breakdowntime,
  ...
  onSubmit(e) {
    ...
    axios.post('https://mernbreakdown.herokuapp.com/breakdowns/update/' + this.props.match.params.id, breakdown)
  ...
  render() {
    ...
    <div>
      ...
      <form onSubmit={this.onSubmit}>
        ...
        <div className="form-group">
          <input type="submit" value="Update breakdown" className="btn btn-dark" />
        </div>
      </form>
    </div>
    )
